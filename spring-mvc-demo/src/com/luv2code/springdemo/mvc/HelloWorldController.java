...
@Controller
@RequestMapping("/hello") // Parent mapping when the below request mappings are duplicated/same in another controller like sillycontroller
public class HelloWorldController {
	...
	public String shoutDude(HttpServletRequest request, Model model){
		...
		return "helloworld-processed"; // Page to be displayed helloWorld-processed.jsp
	}
